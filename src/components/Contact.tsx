...
export default function Contact({ activeSection }: { activeSection?: string }) {
  ...
  const handleDownloadResume = () => {
    const markdownContent = `# PONMALAR S - CYBERSECURITY & WEB DEVELOPMENT RESUME
            ...
            <div className="glass-panel rounded-2xl p-6 border border-white/5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <span className="text-[9px] font-mono text-white/40 mt-1 uppercase tracking-wider">ponmalarp</span>
                </a>
